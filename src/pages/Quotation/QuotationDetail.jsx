...
const OrderForm = () => {
    ...
    const { register, handleSubmit, formState: { errors, isValid }, watch, setValue } = useForm({
        ...
        defaultValues: {
            ...
            totalPrice: quotation.totalPrice || quotation.price || "",
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // Prepare files data (you would upload these files to a server in real implementation)
            ...
            const orderData = {
                ...
                quotationId: quotation._id // Reference to the original quotation
            };
        ...
        <div className="flex flex-col justify-center bg-[#e6f0df] min-h-screen py-4 px-4 sm:py-8">
            <div className="mx-auto w-full max-w-4xl">
                <div className="bg-white border border-gray-200 shadow-lg w-full rounded-lg p-3 sm:p-4 md:p-6">
                    <SectionTitle title={`Convert Quotation to Order`} path={`Home > Quotations > Convert to Order`} />
