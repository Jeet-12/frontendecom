...
const OrderForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append('width', data.width.trim());
      formData.append('height', data.height.trim());
      ...
      <div className="mx-auto w-full max-w-4xl">
        <div className="bg-white border border-gray-200 shadow-lg w-full rounded-lg p-3 sm:p-4 md:p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate encType="multipart/form-data">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div >
                ...
                <input
                  ...
                  placeholder="Enter colors separated by spaces (e.g., red blue green)"
                />
                {errors.colors && (
            ...
            <button
              type="submit"
              className={`bg-[#93C572] hover:bg-[#79a759] text-white font-semibold w-full py-3 rounded-lg shadow-md transition-colors flex justify-center items-center mt-8 ${!isValid || isLoading ? "opacity-50 cursor-not-allowed" : ""
                }`}
